...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002249319477"))

#OWNER ID
OWNER_ID = int(os.environ.get("OWNER_ID", "6668627674 5340652544"))

#Port
PORT = os.environ.get("PORT", "8080")

#Database 
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://smkbotz:WDOWlKerPpg7pEgj@cluster0.qyrkzwz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
#Force sub message 
FORCE_MSG = os.environ.get("FORCE_SUB_MESSAGE", "Hello {first}\n\n<b>You need to join in my Channel/Group to use me\n\nKindly Please join : <a href='https://t.me/unreal_X_bot'>Cʟɪᴄᴋ Mᴇ 🖤</a></b>")
